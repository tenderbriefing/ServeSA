...
function AccountMunicipalitySection() {
  ...
  }, [userProfile?.province, municipalityCode])
  ...
  const persist = async () => {
    ...
    try {
      ...
      setEditing(false)
      setConfirming(false)
      setMessage('Municipality updated. Local updates and plans will use this municipality.')
    } catch (e) {
      setError(
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-body-sm text-ink-muted">
            ...
            Changing this never grants municipal staff permissions.
          </p>
            ...
            <div className="mt-4 space-y-4">
              ...
              {!confirming ? (
                <div className="flex flex-wrap gap-2">
                  <Button
                    className="min-h-touch"
                    disabled={!selection.municipalityCode || !selection.province}
